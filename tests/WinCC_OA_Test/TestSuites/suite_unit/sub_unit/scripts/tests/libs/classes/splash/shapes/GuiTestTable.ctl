/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/Guitestable.ctl.
  @test Verifies the shape wrapper library can create and validate a live TABLE shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestTable.
  @AIgeneratedHelpContent
*/
class TstGuiTestTable : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testable",
    ...
    GuiTestTable wrapper = GuiTestTable(testShape);
