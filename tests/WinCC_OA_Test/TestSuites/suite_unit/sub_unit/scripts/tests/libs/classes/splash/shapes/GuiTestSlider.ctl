/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestSlider.ctl.
  @test Verifies the shape wrapper library can create and validate a live SLIDER shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestSlider.
  @AIgeneratedHelpContent
*/
class TstGuiTestSlider : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testSlider",
    ...
    GuiTestSlider wrapper = GuiTestSlider(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"SLIDER"> testShape;
};
