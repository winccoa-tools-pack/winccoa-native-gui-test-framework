/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestCheckBox.ctl.
  @test Verifies the shape wrapper library can create and validate a live CHECKBOX shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestCheckBox.
  @AIgeneratedHelpContent
*/
class TstGuiTestCheckBox : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testCheckBox",
    ...
    GuiTestCheckBox wrapper = GuiTestCheckBox(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"CHECKBOX"> testShape;
};
