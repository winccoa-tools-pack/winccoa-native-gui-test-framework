/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestDpType.ctl.
  @test Verifies the shape wrapper library can create and validate a live DP_TYPE shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestDpType.
  @AIgeneratedHelpContent
*/
class TstGuiTestDpType : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testDpType",
    ...
    GuiTestDpType wrapper = GuiTestDpType(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"DP_TYPE"> testShape;
};
