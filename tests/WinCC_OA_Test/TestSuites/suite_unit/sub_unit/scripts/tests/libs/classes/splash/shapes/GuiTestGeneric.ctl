/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestGeneric.ctl.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestGeneric.
  @AIgeneratedHelpContent
*/
class TstGuiTestGeneric : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testGeneric",
    ...
    GuiTestGeneric wrapper = GuiTestGeneric(testShape);
