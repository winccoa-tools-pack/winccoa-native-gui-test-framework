/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestSpinButton.ctl.
  @test Verifies the shape wrapper library can create and validate a live SPIN_BUTTON shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestSpinButton.
  @AIgeneratedHelpContent
*/
class TstGuiTestSpinButton : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testSpinButton",
    ...
    GuiTestSpinButton wrapper = GuiTestSpinButton(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"SPIN_BUTTON"> testShape;
};
