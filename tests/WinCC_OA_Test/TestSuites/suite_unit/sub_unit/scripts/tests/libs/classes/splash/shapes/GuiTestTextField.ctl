/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestTextField.ctl.
  @test Verifies the shape wrapper library can create and validate a live TEXT_FIELD shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestTextField.
  @AIgeneratedHelpContent
*/
class TstGuiTestTextField : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testextField",
    ...
    GuiTestTextField wrapper = GuiTestTextField(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"TEXT_FIELD"> testShape;
};
