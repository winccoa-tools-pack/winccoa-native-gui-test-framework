/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestEllipse.ctl.
  @test Verifies the shape wrapper library can create and validate a live ELLIPSE shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestEllipse.
  @AIgeneratedHelpContent
*/
class TstGuiTestEllipse : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testEllipse",
    ...
    GuiTestEllipse wrapper = GuiTestEllipse(testShape);
    ...
    // note: the ELLIPSE shape does not support size attributes, so the wrapper will always return 1 for width and height
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"ELLIPSE"> testShape;
};
