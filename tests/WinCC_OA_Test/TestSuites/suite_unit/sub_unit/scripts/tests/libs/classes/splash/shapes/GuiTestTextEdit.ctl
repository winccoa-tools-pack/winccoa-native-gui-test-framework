/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuitestextEdit.ctl.
  @test Verifies the shape wrapper library can create and validate a live TEXT_EDIT shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestTextEdit.
  @AIgeneratedHelpContent
*/
class TstGuiTestTextEdit : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testextEdit",
    ...
    GuiTestTextEdit wrapper = GuiTestTextEdit(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"TEXT_EDIT"> testShape;
};
