/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestLabel.ctl.
  @test Verifies the shape wrapper library can create and validate a live LABEL shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestLabel.
  @AIgeneratedHelpContent
*/
class TstGuiTestLabel : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testLabel",
    ...
    GuiTestLabel wrapper = GuiTestLabel(testShape);
