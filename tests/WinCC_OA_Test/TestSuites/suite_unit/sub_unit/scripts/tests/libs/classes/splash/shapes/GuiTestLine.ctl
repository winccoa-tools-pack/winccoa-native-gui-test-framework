/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestLine.ctl.
  @test Verifies the shape wrapper library can create and validate a live LINE shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestLine.
  @AIgeneratedHelpContent
*/
class TstGuiTestLine : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testLine",
    ...
    GuiTestLine wrapper = GuiTestLine(testShape);
