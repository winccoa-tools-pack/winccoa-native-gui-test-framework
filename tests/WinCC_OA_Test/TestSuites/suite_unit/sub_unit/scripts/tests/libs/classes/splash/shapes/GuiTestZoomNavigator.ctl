/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestZoomNavigator.ctl.
  @test Verifies the shape wrapper library can create and validate a live ZOOM_NAVIGATOR shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestZoomNavigator.
  @AIgeneratedHelpContent
*/
class TstGuiTestZoomNavigator : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  public int setUp()
  {
    ...
    testShape = addShape("shapesTestModule", "shapesTestPanel", 1,
                         "ZOOM_NAVIGATOR", "testZoomNavigator");
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testZoomNavigator",
    ...
    GuiTestZoomNavigator wrapper = GuiTestZoomNavigator(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"ZOOM_NAVIGATOR"> testShape;
};
