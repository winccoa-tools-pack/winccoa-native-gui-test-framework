/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestEmbeddedModule.ctl.
  @test Verifies the shape wrapper library can create and validate a live EMBEDDED_MODULE shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestEmbeddedModule.
  @AIgeneratedHelpContent
*/
class TstGuiTestEmbeddedModule : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  public int setUp()
  {
    ...
    testShape = addShape("shapesTestModule", "shapesTestPanel", 1,
                         "EMBEDDED_MODULE", "testEmbeddedModule");
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testEmbeddedModule",
    ...
    GuiTestEmbeddedModule wrapper = GuiTestEmbeddedModule(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"EMBEDDED_MODULE"> testShape;
};
