/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestProgressBar.ctl.
  @test Verifies the shape wrapper library can create and validate a live PROGRESS_BAR shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestProgressBar.
  @AIgeneratedHelpContent
*/
class TstGuiTestProgressBar : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testProgressBar",
    ...
    GuiTestProgressBar wrapper = GuiTestProgressBar(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"PROGRESS_BAR"> testShape;
};
