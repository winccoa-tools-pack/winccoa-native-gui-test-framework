/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestDpTree.ctl.
  @test Verifies the shape wrapper library can create and validate a live DP_TREE shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestDpTree.
  @AIgeneratedHelpContent
*/
class TstGuiTestDpTree : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testDpTree",
    ...
    GuiTestDpTree wrapper = GuiTestDpTree(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"DP_TREE"> testShape;
};
