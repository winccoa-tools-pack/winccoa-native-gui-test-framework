/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/Guitestree.ctl.
  @test Verifies the shape wrapper library can create and validate a live TREE shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestTree.
  @AIgeneratedHelpContent
*/
class TstGuiTestTree : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testree",
    ...
    GuiTestTree wrapper = GuiTestTree(testShape);
