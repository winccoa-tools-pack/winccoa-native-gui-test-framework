/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestLcd.ctl.
  @test Verifies the shape wrapper library can create and validate a live LCD shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestLcd.
  @AIgeneratedHelpContent
*/
class TstGuiTestLcd : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testLcd",
    ...
    GuiTestLcd wrapper = GuiTestLcd(testShape);
