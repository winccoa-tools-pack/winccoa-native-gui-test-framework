/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/Guitestab.ctl.
  @test Verifies the shape wrapper library can create and validate a live TAB shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestTab.
  @AIgeneratedHelpContent
*/
class TstGuiTestTab : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testab",
    ...
    GuiTestTab wrapper = GuiTestTab(testShape);
