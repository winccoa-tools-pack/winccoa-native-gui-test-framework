/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestPrimitiveText.ctl.
  @test Verifies the shape wrapper library can create and validate a live PRIMITIVE_TEXT shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestPrimitiveText.
  @AIgeneratedHelpContent
*/
class TstGuiTestPrimitiveText : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  public int setUp()
  {
    ...
    testShape = addShape("shapesTestModule", "shapesTestPanel", 1,
                         "PRIMITIVE_TEXT", "testPrimitiveText");
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testPrimitiveText",
    ...
    GuiTestPrimitiveText wrapper = GuiTestPrimitiveText(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"PRIMITIVE_TEXT"> testShape;
};
