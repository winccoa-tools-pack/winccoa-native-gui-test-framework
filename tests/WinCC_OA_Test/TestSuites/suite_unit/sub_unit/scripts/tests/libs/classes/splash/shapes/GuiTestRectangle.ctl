/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestRectangle.ctl.
  @test Verifies the shape wrapper library can create and validate a live RECTANGLE shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestRectangle.
  @AIgeneratedHelpContent
*/
class TstGuiTestRectangle : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testRectangle",
    ...
    GuiTestRectangle wrapper = GuiTestRectangle(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"RECTANGLE"> testShape;
};
