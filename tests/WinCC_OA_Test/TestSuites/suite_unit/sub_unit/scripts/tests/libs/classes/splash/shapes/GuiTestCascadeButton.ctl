/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestCascadeButton.ctl.
  @test Verifies the shape wrapper library can create and validate a live CASCADE_BUTTON shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestCascadeButton.
  @AIgeneratedHelpContent
*/
class TstGuiTestCascadeButton : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  public int setUp()
  {
    ...
    testShape = addShape("shapesTestModule", "shapesTestPanel", 1,
                         "CASCADE_BUTTON", "testCascadeButton");
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testCascadeButton",
    ...
    GuiTestCascadeButton wrapper = GuiTestCascadeButton(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"CASCADE_BUTTON"> testShape;
};
