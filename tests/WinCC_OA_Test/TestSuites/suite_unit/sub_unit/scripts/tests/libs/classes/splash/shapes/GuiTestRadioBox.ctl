/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestRadioBox.ctl.
  @test Verifies the shape wrapper library can create and validate a live RADIO_BOX shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestRadioBox.
  @AIgeneratedHelpContent
*/
class TstGuiTestRadioBox : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testRadioBox",
    ...
    GuiTestRadioBox wrapper = GuiTestRadioBox(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"RADIO_BOX"> testShape;
};
