/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestFrame.ctl.
  @test Verifies the shape wrapper library can create and validate a live FRAME shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestFrame.
  @AIgeneratedHelpContent
*/
class TstGuiTestFrame : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testFrame",
    ...
    GuiTestFrame wrapper = GuiTestFrame(testShape);
