/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestArc.ctl.
  @test Verifies the shape wrapper library can create and validate a live ARC shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestArc.
  @AIgeneratedHelpContent
*/
class TstGuiTestArc : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testArc",
    ...
    GuiTestArc wrapper = GuiTestArc(testShape);
    ...
    // note: the size cannot be set on an ARC shape, so the wrapper will always return 1 for width and height
