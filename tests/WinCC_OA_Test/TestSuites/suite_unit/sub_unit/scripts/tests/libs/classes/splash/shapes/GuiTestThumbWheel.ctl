/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuitesthumbWheel.ctl.
  @test Verifies the shape wrapper library can create and validate a live THUMB_WHEEL shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestThumbWheel.
  @AIgeneratedHelpContent
*/
class TstGuiTestThumbWheel : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testhumbWheel",
    ...
    GuiTestThumbWheel wrapper = GuiTestThumbWheel(testShape);
...
//@private members
//-----------------------------------------------------------------------------
  private shape<"THUMB_WHEEL"> testShape;
};
