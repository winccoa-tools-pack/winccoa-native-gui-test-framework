/**
  @file $relPath
  @copyright MIT
  @brief Real tests for classes/splash/shapes/GuiTestClock.ctl.
  @test Verifies the shape wrapper library can create and validate a live CLOCK shape.
...
//------------------------------------------------------------------------------
/**
  @brief Real tests for GuiTestClock.
  @AIgeneratedHelpContent
*/
class TstGuiTestClock : OaTest
{
//-----------------------------------------------------------------------------
//@public members
//-----------------------------------------------------------------------------
  ...
  */
  ...
  {
    this.assertEqual(testShape.name(), "testClock",
    ...
    GuiTestClock wrapper = GuiTestClock(testShape);
