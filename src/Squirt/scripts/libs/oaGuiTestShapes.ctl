...
//------------------------------------------------------------------------------
/**
  @brief Builds the GuiTestShape wrapper for a live panel shape.
  @param testShape Live WinCC OA shape.
  @return Typed GuiTestShape instance for the shape type.
*/
...
/**
  @brief Reads current test attributes for a live shape.
  @param realShape Live WinCC OA shape.
  @return Attribute mapping from the matching GuiTestShape wrapper.
*/
...
/**
  @brief Returns a stable name path for a shape used as VP key.
  @param _shape Live WinCC OA shape.
  @return Shape namePath, or shape name when path is empty.
*/
